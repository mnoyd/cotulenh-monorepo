...
import { AIR_FORCE, BLUE, INFANTRY, MILITIA, NAVY, PieceSymbol, TANK } from '../src/type'
...
describe('CoTuLenh.getHeroicStatus', () => {
  ...
  it('returns the heroic status of a carried piece if pieceType is specified', () => {
    game.put({ type: INFANTRY, color: BLUE, heroic: false, carried: [
  ...
  it('returns false if carried piece of specified type does not exist', () => {
    game.put({ type: INFANTRY, color: BLUE, heroic: false, carried: [
      { type: TANK, color: BLUE, heroic: true },
    ] }, 'e4')
  ...
  it('returns the heroic status of a carried piece if pieceType is specified', () => {
    game.put({ type: NAVY, color: BLUE, heroic: false, carried: [
      { type: TANK, color: BLUE, heroic: true },
