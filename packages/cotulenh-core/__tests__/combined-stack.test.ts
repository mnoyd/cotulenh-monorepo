...
//       SQUARE_MAP.c1,
//     )
//     const airForceMovesInternal = internalMoves.get(AIR_FORCE)
//     const airForceMoves = airForceMovesInternal?.map((m) => new Move(game,m)) as Move[]
