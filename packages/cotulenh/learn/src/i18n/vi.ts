  ...
  subjects: {
    'subject-1-basic-movement': {
      subject: {
        ...
        description:
          'Nắm vững các kiểu di chuyển của cả 11 loại quân trong Cờ Tư Lệnh, từ các quân cơ bản 1 ô đến các đơn vị tầm xa chuyên biệt.',
...
- **Tăng (T)**: Di chuyển tối đa 2 ô theo phương thẳng. Có thể chở quân và tuân theo quy tắc chặn bình thường.
- **Tên Lửa (S)**: Kiểu hình tròn độc đáo - 2 ô theo phương thẳng HOẶC 1 ô theo đường chéo. Cũng cung cấp phòng không.

### Quân Tầm Xa (3+ ô)
- **Pháo (A)**: Di chuyển tối đa 3 ô theo cả 8 hướng. Di chuyển bị chặn, còn bắt quân có quy tắc tầm xa riêng.
...
**Chặn**: Hầu hết các quân không thể đi qua các quân khác. Không Quân bỏ qua chặn khi di chuyển, còn các ngoại lệ về bắt quân sẽ được học ở các môn sau.
...
Khai thác sức mạnh của Pháo (3 ô mọi hướng), Không Quân (bay 4 ô), và Hải Quân (kiểm soát biển).
...
Chúng cung cấp sự linh hoạt chiến thuật giữa các quân 1 ô cơ bản và các quân tầm xa mạnh.`
        ...
        'section-3-advanced-units': {
          ...
          description:
            'Làm chủ các quân mạnh: Pháo (3 ô mọi hướng), Không Quân (bay 4 ô), và Hải Quân (trên nước).',
          introduction: `# Quân Nâng Cao & Đặc Biệt

Các quân này có đặc điểm di chuyển mạnh:
- **Pháo**: Tầm 3 ô theo đủ 8 hướng, với quy tắc bắt quân đặc biệt
- **Không Quân**: Bay tầm 4 qua các quân chặn nhưng vẫn phải hạ cánh hợp lệ
...
- Tuân theo cùng quy tắc chặn cho di chuyển và bắt quân trong core hiện tại.`,
          instruction:
...
- Tạo ra **vùng phòng không 2 ô**.`,
        ...
        'bm-3-1': {
          ...
          description: 'Pháo di chuyển tối đa 3 ô theo mọi hướng và sẽ học quy tắc bắt quân riêng sau.',
          content: `## Pháo

- Di chuyển **tối đa 3 ô theo mọi hướng**.
- **Quân nặng**: phải sử dụng **ô cầu** để qua sông.
- Di chuyển vẫn cần đường thông, còn quy tắc bắt tầm xa được học ở phần sau.`,
          instruction:
            'Di chuyển Pháo. Pháo có thể đi tối đa 3 ô theo đường thẳng hoặc đường chéo, nhưng vẫn cần đường đi thông thoáng.',
          hint: 'Hãy thử nước đi 1, 2, hoặc 3 ô theo đường thẳng hay đường chéo.',
          successMessage:
            'Xuất sắc! Pháo kết hợp tầm 3 ô với khả năng đi đủ 8 hướng.'
        },
        'bm-3-2': {
          title: 'Di Chuyển Không Quân',
          description:
            'Không Quân có thể bay tối đa 4 ô theo mọi hướng, bỏ qua quân chặn nhưng vẫn phải hạ cánh hợp lệ.',
          content: `## Không Quân

- Bay **tối đa 4 ô** theo bất kỳ hướng nào.
- **Bỏ qua quân chặn** và có thể bay qua địa hình bị cấm.
- Nhưng vẫn phải **hạ cánh trên ô đích hợp lệ**.
- Chịu ảnh hưởng bởi **vùng phòng không** địch.`,
          instruction:
            'Di chuyển Không Quân. Nó có thể tới các ô đích hợp lệ trong khoảng cách 4 trong khi bay qua các quân xen giữa.',
          hint:
            'Không Quân có thể bay qua địa hình bị cấm, nhưng vẫn không thể kết thúc ở ô hải quân thuần.',
          successMessage:
...
### Tăng - Bị Chặn Khi Di Chuyển Và Bắt
- **Di chuyển**: BỊ CHẶN - Không thể di chuyển qua các quân khác
- **Bắt quân**: BỊ CHẶN - Cần đường thông tới mục tiêu trong core hiện tại
...
**Tấn Công Từ Xa**: Pháo và Tên Lửa có thể xử lý mục tiêu sau hàng chặn, còn Tăng vẫn cần hành lang trống.
...
- Nhận ra rằng Tăng vẫn cần hành lang trống để di chuyển và bắt quân
...
- Sử dụng lanes ven biển để lẻn qua sự tắc nghẽn trên đất.`,
        ...
        'blocking-4': {
          title: 'Tăng Không Bắt Xuyên Quân Chặn',
          description: 'Tăng dùng cùng quy tắc chặn cho cả di chuyển lẫn bắt quân.',
          content: `## Quy Tắc Chặn Của Tăng

- Tăng **không thể di chuyển qua** các quân.
- Tăng **không thể bắt qua** một quân chặn đơn.
- Nếu có quân chắn trên đường, Tăng phải đổi tuyến hoặc đổi mục tiêu.`,
          instruction:
            'Quan sát thế cờ. Tăng ở e4 không thể bắt quân địch ở e7 vì Bộ Bin ở e5 chặn đường. Nhấp vào Tăng hoặc bất kỳ ô nào để hoàn thành bài học.',
          hint: 'Quân chắn ở e5 ngăn cả di chuyển lẫn bắt quân của Tăng trên cột đó.',
          successMessage: 'Chính xác! Tăng không có nước bắt xuyên chặn trong luật hiện tại.'
        },
        'blocking-5': {
...
- Sử dụng điều này để hoàn thành các thao tác đa quân`,
    ...
    'subject-8-heroic-rule': {
      subject: {
        ...
        description: 'Thăng cấp quân bằng cách chiếu, hiểu Last Guard, và sử dụng di chuyển anh hùng.',
...
- Xem cách **Last Guard** tự động phong anh hùng cho quân hộ vệ cuối cùng`
      },
      sections: {
...
Một khi được thăng cấp, cùng đơn vị có di chuyển mở rộng. Sử dụng nâng cấp đó để tiếp cận mục tiêu xa hơn.`
        ...
        'section-3-last-guard': {
          title: 'Last Guard',
          description: 'Xem quân hộ vệ cuối cùng tự động được phong anh hùng.',
          introduction: `# Phong Cấp Last Guard

Khi một bên chỉ còn **Tư Lệnh + 1 quân nguyên tử không phải tư lệnh**, quân hộ vệ cuối cùng đó tự động trở thành anh hùng.`
        }
      },
      lessons: {
        'heroic-rule-1': {
...
- Tầm nâng cao này áp dụng cho cả di chuyển và bắt`,
        ...
        'heroic-rule-3': {
          title: 'Phong Cấp Last Guard',
          description:
            'Khi một bên chỉ còn Tư Lệnh cộng với một quân nguyên tử không phải tư lệnh, quân hộ vệ cuối cùng đó trở thành anh hùng.',
          content: `# Last Guard

- Khi một bên chỉ còn **Tư Lệnh + 1 quân nguyên tử không phải tư lệnh**, quy tắc **Last Guard** kích hoạt
- Quân còn lại đó tự động trở thành **anh hùng**
- Quy tắc có thể áp dụng cho Bộ Bin, Tăng, Bộ Tư Lệnh, hoặc quân phù hợp khác`,
          instruction:
            'Di chuyển Tăng xanh từ d3 đến d2 để bắt Bộ Bin đỏ. Quân hộ vệ đỏ cuối cùng ở f2 sẽ tự động được phong.',
          hint:
            'Sau khi bắt ở d2, Đỏ chỉ còn Tư Lệnh + 1 quân không phải tư lệnh, nên Bộ Bin ở f2 trở thành +I.',
          successMessage: 'Chính xác! Last Guard đã phong Bộ Bin còn lại ở f2 thành anh hùng.'
        }
      }
    },
...
- Quy tắc này ngăn các tình huống "tướng bay"`,
    ...
    'subject-10-game-state-rules': {
      subject: {
        title: 'Quy Tắc Trạng Thái Ván',
        description:
          'Tìm hiểu cách CotuLenh phân biệt chiếu, nguy hiểm, kết thúc ván, và các điều kiện hòa.',
        introduction: `# Quy Tắc Trạng Thái Ván

Những quy tắc này quyết định khi nào một thế cờ chỉ là nguy hiểm, khi nào là chiếu, khi nào ván đấu kết thúc, và khi nào nó được xử hòa.

## Nội Dung Môn Học

- **Nguy hiểm cho tư lệnh** so với **chiếu**
- **Chiếu hết** so với **bí**
- **Bắt tư lệnh** như kết quả kết thúc ngay lập tức
- Hòa bởi **50 nước** và **lặp lại ba lần**
- Vì sao **phiên triển khai** đang mở sẽ tạm hoãn \`isGameOver()\` cho tới khi cam kết`
      },
      sections: {
        'section-1-commander-state': {
          title: 'Trạng Thái Tư Lệnh',
          description: 'Phân biệt nguy hiểm, chiếu, chiếu hết, và bí.',
          introduction: `# Trạng Thái Tư Lệnh

Hãy bắt đầu bằng cách tách rõ các khái niệm an toàn của tư lệnh:

- **Nguy hiểm** có thể bao gồm tấn công trực tiếp hoặc lộ mặt
- **Chiếu** nghĩa là bị tấn công trực tiếp
- **Chiếu hết** là bị chiếu và không còn nước thoát hợp lệ
- **Bí** là không còn nước đi hợp lệ nhưng cũng không bị chiếu`
        },
        'section-2-terminal-and-draws': {
          title: 'Kết Thúc Và Hòa',
          description: 'Học bắt tư lệnh, điều kiện hòa, và ngoại lệ về thời điểm triển khai.',
          introduction: `# Kết Thúc Và Hòa

Không phải mọi thế cờ kết thúc đều giống nhau. Có thế là thắng ngay, có thế là hòa, và phiên triển khai có thể trì hoãn kiểm tra kết thúc ván cho tới khi chuỗi được cam kết.`
        }
      },
      lessons: {
        'game-state-1': {
          title: 'Nguy Hiểm Rộng Hơn Chiếu',
          description:
            'Hai tư lệnh có thể đối mặt trực tiếp và tạo nguy hiểm dù engine không báo chiếu.',
          content: `# Nguy Hiểm So Với Chiếu

- **Chiếu** nghĩa là tư lệnh bị tấn công trực tiếp
- **Nguy hiểm cho tư lệnh** rộng hơn và còn bao gồm thế lộ mặt do quy tắc tướng bay
- Một thế cờ có thể nguy hiểm dù \`isCheck()\` là false`,
          instruction:
            'Quan sát thế cờ. Hai tư lệnh đang đối mặt trên cùng cột, nên đây là nguy hiểm cho tư lệnh, nhưng không phải chiếu trực tiếp. Nhấp vào bất kỳ ô nào để hoàn thành.',
          hint:
            'Chiếu cần tấn công trực tiếp. Nguy hiểm cho tư lệnh còn gồm cả lộ mặt do quy tắc tướng bay.',
          successMessage:
            'Chính xác! Nguy hiểm cho tư lệnh bao gồm cả thế lộ mặt, ngay cả khi \`isCheck()\` là false.'
        },
        'game-state-2': {
          title: 'Nhận Diện Chiếu Hết',
          description: 'Chiếu hết nghĩa là tư lệnh đang bị chiếu và không còn nước thoát hợp lệ.',
          content: `# Chiếu Hết

- Tư lệnh đang **bị chiếu**
- Bên tới lượt **không còn nước thoát hợp lệ**
- Nếu còn dù chỉ một nước trả lời hợp lệ thì chưa phải chiếu hết`,
          instruction:
            'Quan sát bàn cờ. Đỏ đang bị chiếu và không có cách hợp lệ nào để thoát, nên đây là chiếu hết. Nhấp vào bất kỳ ô nào để hoàn thành.',
          hint:
            'Tăng ở f2 đang chiếu, Bộ Bin ở e1 và g1 chặn đường ngang, còn e2/g2 che các nước bắt trả.',
          successMessage: 'Chính xác! Chiếu hết cần vừa có chiếu vừa không còn nước thoát.'
        },
        'game-state-3': {
          title: 'Nhận Diện Bí',
          description: 'Bí nghĩa là bên tới lượt không bị chiếu nhưng vẫn không còn nước đi hợp lệ.',
          content: `# Bí

- Bên tới lượt **không bị chiếu**
- Nhưng vẫn **không còn nước đi hợp lệ**
- Bí là hòa, không phải thua bởi chiếu hết`,
          instruction:
            'Quan sát bàn cờ. Xanh không bị chiếu, nhưng Xanh không có nước đi hợp lệ nào nên đây là bí. Nhấp vào bất kỳ ô nào để hoàn thành.',
          hint: 'Bí khác chiếu hết ở chỗ tư lệnh bị kẹt nhưng không bị tấn công trực tiếp.',
          successMessage: 'Chính xác! Không còn nước đi mà không bị chiếu là bí.'
        },
        'game-state-4': {
          title: 'Bắt Tư Lệnh Kết Thúc Ván',
          description: 'Bắt được tư lệnh đối phương sẽ kết thúc ván ngay lập tức.',
          content: `# Bắt Tư Lệnh

- Loại bỏ một trong hai tư lệnh sẽ kết thúc ván ngay
- Engine theo dõi sự tồn tại của tư lệnh riêng với việc tìm chiếu hết
- Một nước bắt tư lệnh hợp lệ là kết quả kết thúc ngay khi nước đi hoàn tất`,
          instruction:
            'Dùng Tăng xanh ở f3 bắt Tư Lệnh đỏ trên f1. Bắt tư lệnh sẽ kết thúc ván ngay lập tức.',
          hint: 'Tăng có tầm bắt 2 ô theo phương thẳng, nên \`f3 -> f1\` là hợp lệ.',
          successMessage: 'Chính xác! Bắt tư lệnh là kết quả kết thúc ngay khi nước đi hạ xuống.'
        },
        'game-state-5': {
          title: 'Luật Hòa Và Thời Điểm Triển Khai',
          description:
            'Phát hiện hòa gồm luật 50 nước, lặp lại vị trí, và ngoại lệ thời điểm cho phiên triển khai.',
          content: `# Luật Hòa

- **Luật 50 nước** kích hoạt khi bộ đếm halfmove đạt **100**
- **Lặp lại ba lần** phụ thuộc việc cùng một vị trí đầy đủ xuất hiện ba lần với cùng bên được đi
- **Phiên triển khai** đang mở sẽ tạm thời chặn \`isGameOver()\` cho tới khi triển khai được cam kết`,
          instruction:
            'Quan sát bàn cờ. Bộ đếm halfmove đã đạt ngưỡng 50 nước, nên thế cờ này có thể được xử hòa dù bàn cờ yên tĩnh. Nhấp vào bất kỳ ô nào để hoàn thành.',
          hint:
            'Engine còn theo dõi lặp lại ba lần bằng lịch sử vị trí đầy đủ, và phiên triển khai đang mở sẽ trì hoãn \`isGameOver()\` cho tới khi xử lý xong.',
          successMessage: 'Chính xác! Logic hòa phụ thuộc cả bàn cờ lẫn lịch sử ván.'
        }
      }
    }
  }
