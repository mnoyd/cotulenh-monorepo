/**
 * Subject 3: Capture - Introduction Content
 *
 * This file contains the markdown introduction for Subject 3.
 * Separated from lesson definitions for easier content management.
 */

export const subject3Introduction = `
# Capture in Cotulenh
...
export const section1CaptureBasicsIntro = `
# Capture Basics
