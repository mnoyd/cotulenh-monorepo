...
export const en: TranslationKeys = {
  ...
  'friends.toast.requestDeclined': 'Friend request declined',
  'friends.toast.requestCancelled': 'Friend request cancelled',
  'friends.toast.actionFailed': 'Action failed. Please try again.',
  'friends.status.online': 'Online',
  'friends.status.offline': 'Offline',
  'friends.remove.button': 'Remove',
  'friends.remove.title': 'Remove Friend',
  'friends.remove.description': 'Are you sure you want to remove {name} from your friends list?',
  'friends.remove.confirm': 'Remove',
  'friends.remove.cancel': 'Cancel',
  'friends.toast.friendRemoved': 'Friend removed',
  'friends.toast.removeFailed': 'Failed to remove friend. Please try again.',
  ...
  'inviteLink.pageTitle': 'Game Invitation',
  'inviteLink.invitedYou': 'invited you to play',
  'inviteLink.acceptAndPlay': 'Accept & Play',
  'inviteLink.signUpToPlay': 'Sign Up to Play',
  ...
  'inviteLink.linkLabel': 'Invite link URL',
  ...
  'game.opponentReconnectCountdown': 'Opponent reconnecting... ({seconds}s left)',
  'game.opponentDisconnectForfeit': 'Opponent disconnected — you win',
  'game.connectionRestored': 'Connection restored',
  'game.clocksPaused': 'Clocks paused',
  'game.disconnectForfeit': 'Disconnected too long — opponent wins',
