...
export const vi: TranslationKeys = {
  ...
  'inviteLink.pageTitle': 'Lời Mời Chơi',
  'inviteLink.invitedYou': 'đã mời bạn chơi',
  'inviteLink.acceptAndPlay': 'Chấp Nhận & Chơi',
  'inviteLink.signUpToPlay': 'Đăng Ký Để Chơi',
  'inviteLink.alreadyHaveAccount': 'Đã có tài khoản?',
  'inviteLink.logIn': 'Đăng Nhập',
  'inviteLink.expired.title': 'Lời Mời Không Khả Dụng',
  'inviteLink.expired.description': 'Lời mời này đã hết hạn, bị hủy, hoặc đã được chấp nhận.',
  'inviteLink.own.title': 'Lời Mời Của Bạn',
  'inviteLink.own.description': 'Chia sẻ liên kết này để mời người khác chơi.',
  'inviteLink.copyLink': 'Sao Chép Liên Kết',
  'inviteLink.linkLabel': 'URL liên kết mời',
